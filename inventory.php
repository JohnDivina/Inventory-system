...
<div class="modal" id="ulamModal">
    <div class="modal-content">
        <div class="modal-header">
            <h3 id="ulamModalTitle">Bagong Ulam</h3>
        </div>
        <div class="modal-body">
            <form id="ulamForm">
                ...
                <div class="form-group">
                    <label for="ulamName">Pangalan ng Ulam *</label>
                    <input type="text" id="ulamName" name="name" class="form-control" required>
                </div>
                
                <div class="form-group">
                    <label for="ulamPrice">Presyo (₱) *</label>
        ...
        <div class="modal-footer">
            <button class="btn btn-secondary" onclick="hideUlamModal()">Kanselahin</button>
            <button class="btn btn-primary" onclick="saveUlam()">I-save</button>
        </div>
    </div>
</div>
...
<div class="modal" id="ingredientModal">
    <div class="modal-content">
        <div class="modal-header">
            <h3 id="ingredientModalTitle">Bagong Sangkap</h3>
        </div>
        <div class="modal-body">
            <form id="ingredientForm">
                ...
                <div class="form-group">
                    <label for="ingredientName">Pangalan ng Sangkap *</label>
        ...
        <div class="modal-footer">
            <button class="btn btn-secondary" onclick="hideIngredientModal()">Kanselahin</button>
            <button class="btn btn-primary" onclick="saveIngredient()">I-save</button>
        </div>
    </div>
</div>
